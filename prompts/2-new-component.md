...
This adds the component to `/src/src/components/ui/`.
...
If the base component needs additional variants or behavior, create a wrapped version in `/src/components/[ComponentName].tsx`:
...
- Component installed/created in `/src/components/`
